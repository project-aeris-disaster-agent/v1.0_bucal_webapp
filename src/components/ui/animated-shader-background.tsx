      ...
      fragmentShader: `
        ...
        void main() {
          ...
          for (float i = 0.0; i < 35.0; i++) {
            ...
            // BUCAL accent: #a3ff00 on dark #121212
            vec4 auroraColors = vec4(
              0.55 + 0.2 * sin(i * 0.2 + iTime * 0.4),
              0.95 + 0.05 * cos(i * 0.3 + iTime * 0.5),
              0.02 + 0.08 * sin(i * 0.4 + iTime * 0.3),
              1.0
            );
          ...
          gl_FragColor = vec4(o.rgb * 1.4, o.a);
        }
      `,
    });
